...
from mts.subjects.math import question_plan as qp


SECTIONS = [{"id": "monday"}, {"id": "tuesday"}, {"id": "wednesday"}, {"id": "thursday"}, {"id": "friday"}]
FORM_COMPATIBILITY = json.loads((REPO / "data" / "master" / "subjects" / "math" / "question_form_compatibility.json").read_text(encoding="utf-8"))
